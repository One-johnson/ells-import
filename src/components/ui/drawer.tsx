...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Overlay
    ...
    className={cn(
      "data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-[100] bg-black/50",
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        "group/drawer-content bg-background fixed z-[100] flex h-auto flex-col outline-none",
